...
namespace Level_Editor
{
    public partial class MapEditor : Form
    {
        ...
        private void MapEditor_Load(object sender, EventArgs e)
        {
            ...
            cboCodeValues.Items.Add("Health");
            cboCodeValues.Items.Add("Gemstone");
            cboCodeValues.Items.Add("EnemyA");
            cboCodeValues.Items.Add("EnemyB");
            cboCodeValues.Items.Add("EnemyC");
            cboCodeValues.Items.Add("EnemyD");
            cboCodeValues.Items.Add("EnemyE");
            cboCodeValues.Items.Add("EnemyF");
        ...
        private void cboCodeValues_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (cboCodeValues.Items[cboCodeValues.SelectedIndex].ToString())
            {
                ...
                case "EnemyA":
                    txtNewCode.Text = "ENEMY_A";
                    break;

                case "EnemyB":
                    txtNewCode.Text = "ENEMY_B";
                    break;

                case "EnemyC":
                    txtNewCode.Text = "ENEMY_C";
                    break;

                case "EnemyD":
                    txtNewCode.Text = "ENEMY_D";
                    break;

                case "EnemyE":
                    txtNewCode.Text = "ENEMY_E";
                    break;

                case "EnemyF":
                    txtNewCode.Text = "ENEMY_F";
                    break;
